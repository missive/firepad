describe('Integration tests', function() {
  ...
  it('Performs getHtml responsively', function(done) {
    ...
    firepad.on('ready', function() {
      var html = '<div>Foo</div><blockquote><blockquote><div>Foo</div></blockquote></blockquote><div>Foo</div><blockquote><blockquote><ul><li><b>bold</b></li></ul></blockquote></blockquote>';
